...
import org.trimps.images.analyzer.core.codec.AbstractImageDecoder;
import org.trimps.images.analyzer.core.codec.ExtendImageHeaderReader;
import org.trimps.images.analyzer.core.codec.convertor.ColorConvertor;
import org.trimps.images.analyzer.core.codec.convertor.FastInverseDCTCalculator;
import org.trimps.images.analyzer.core.codec.convertor.InverseColorConvertor;
import org.trimps.images.analyzer.core.codec.convertor.InverseDCTCalculator;
import org.trimps.images.analyzer.core.codec.convertor.NullColorConvertor;
import org.trimps.images.analyzer.core.codec.convertor.SlowInverseDCTCalculator;
import org.trimps.images.analyzer.core.codec.convertor.YCCK2CMYKColorConvertor;
import org.trimps.images.analyzer.core.codec.convertor.YCbCr2RGBColorConvertor;
import org.trimps.images.analyzer.core.codec.jpeg.ext.AdobeHeaderReader;
import org.trimps.images.analyzer.core.codec.jpeg.ext.ExtendImageHeader;
import org.trimps.images.analyzer.core.codec.jpeg.ext.ICCProfileReader;
import org.trimps.images.analyzer.core.codec.jpeg.ext.JFIFHeaderReader;
import org.trimps.images.analyzer.core.io.ImageInputStream;
import org.trimps.images.analyzer.core.jai.cmm.CMMColorSpace;
...
public class JPEGDecoder extends AbstractImageDecoder {
    ...
    protected void readFrameHeader(int marker) throws IOException {
        switch (marker) {
            case MarkerConstants.SOF0:
                createFrameHeader(true, false);
                break;
            case MarkerConstants.SOF1:
                createFrameHeader(false, false);
                break;
            case MarkerConstants.SOF2:
                createFrameHeader(false, true);
                break;

            
            case MarkerConstants.SOF9:
            case MarkerConstants.SOF10:
            case MarkerConstants.SOF3: 
            case MarkerConstants.SOF5: 
            case MarkerConstants.SOF6: 
            case MarkerConstants.SOF7: 
            case MarkerConstants.JPG: 
            case MarkerConstants.SOF11: 
            case MarkerConstants.SOF13: 
            case MarkerConstants.SOF14: 
            case MarkerConstants.SOF15: 
            default:
