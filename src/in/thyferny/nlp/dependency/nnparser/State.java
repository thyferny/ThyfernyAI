...
import in.thyferny.nlp.dependency.nnparser.action.Action;
import in.thyferny.nlp.dependency.nnparser.action.ActionFactory;
import in.thyferny.nlp.dependency.nnparser.util.std;
...
public class State {
	 ...
	 * 当前节点的左孩子数量
	 */
	List<Integer> nr_left_children; // ! The number of left children in this
									// state.
	/**
	 * 当前节点的右孩子数量
	 */
	List<Integer> nr_right_children; // ! The number of right children in this
										// state.
	List<Integer> left_most_child; // ! The left most child for each word in
									// this state.
	List<Integer> right_most_child; // ! The right most child for each word in
									// this state.
	List<Integer> left_2nd_most_child; // ! The left 2nd-most child for each
										// word in this state.
	List<Integer> right_2nd_most_child; // ! The right 2nd-most child for each
										// word in this state.
