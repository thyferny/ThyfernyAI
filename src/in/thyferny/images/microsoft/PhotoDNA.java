...
//			i++;
//		}
		DNAKey ret1 = ComputeII144Hash("d:/front.jpg");
...
//		;
	...
	public static DNAKey ComputeII144Hash(String imageFile)// , byte *hashValue
	{
...
//		float[] buffer = floatArray.data;
		...
		if (width < 50 || height < 50) {
			return new DNAKey(COMPUTE_HASH_NO_HASH_CALCULATED_IMAGE_TOO_SMALL, null);
		}
		...
		while (iter < 10 && found == true) {
			...
			if (denom <= 0.0) {
				...
				sumImage = null;
				return new DNAKey(COMPUTE_HASH_NO_HASH_CALCULATED_IMAGE_IS_FLAT, null);
			}
		...
		return new DNAKey(hResult, hashValue);
	}
}
